...
class EntityWrong(Question, pygame.sprite.Sprite):
    def __init__(self):
        pygame.sprite.Sprite.__init__(self)
...
class EntityCorrect(Question, pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        pygame.sprite.Sprite.__init__(self)
        # self.image = pygame.Surface((30, 30))
        ...
        self.font_name = pygame.font.match_font(FONT)
        self.my_font = pygame.font.SysFont(FONT, 30)
        self.image = self.my_font.render(str(self.answer), False, RED)
        self.rect = self.image.get_rect()
        self.rect.x = random.randrange(WIDTH - self.rect.width)
        self.rect.y = random.randrange(-250, -10)
        self.speedy = random.randrange(1, 4)
